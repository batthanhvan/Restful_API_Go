...
func handleField(t reflect.Type, v reflect.Value) bool {
	switch t.Kind() {
	case reflect.String:
		val, _ := interface{}(v.Interface()).(string)
		if val == "" {
			return false
		}
	case reflect.Int:
		val, _ := interface{}(v.Interface()).(int)
		if val == 0 {
			return false
		}
	case reflect.Int16:
		val, _ := interface{}(v.Interface()).(int16)
		if val == 0 {
			return false
		}
	case reflect.Int32:
		val, _ := interface{}(v.Interface()).(int32)
		if val == 0 {
			return false
		}
	case reflect.Int64:
		val, _ := interface{}(v.Interface()).(int64)
		if val == 0 {
			return false
		}
	case reflect.Slice:
